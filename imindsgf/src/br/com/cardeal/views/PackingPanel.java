...
public class PackingPanel extends JPanel  implements OperationWindow, PackingPanelWindows {
	...
	private JButton btnEnter; //- ESPECIFICO BURITIS
...
//		txtPesoLiquido.setEnabled(false); //- ESPECIFICO BURITIS
	...
	public void mousePressedTxtPesoLiquido() {
		GuiGlobals.virtualKeyboardAction(null, txtPesoLiquido, null, this, null, null, null, null, null, null, null, null, null, null, null, null, btnEnter, null);		
	}
	//- ESPECIFICO BURITIS		
...
//				}
		...
		packingData.setNet(Double.parseDouble( txtPesoLiquido.getText() ) ); //- ESPECIFICO BURITIS
