...
public class Setup 
{
	...
	private static boolean refreshLabelsPrinterZebra( boolean copyLabelsFromServer ) {
		...
		String pathLabelsDefault = "http://" + GuiGlobals.getIpServer() + ":" + GuiGlobals.getPortaServer() + GuiGlobals.getSeparadorIvertido() + "imindsgf" + GuiGlobals.getSeparadorIvertido() + "resources" + GuiGlobals.getSeparadorIvertido() + "labels" + GuiGlobals.getSeparadorIvertido() ;
