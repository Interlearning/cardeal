	...
	switch (id) 
	{
		case "listStock":
			a = '<header><h2>Opções para Exportação</h2>' +
				...
				'<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportStockProductionToPDF">' +
			    ...
			    '</form>' +
			    '<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportStockToExcel">' +
			    '<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
				'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
		...
		case "listStockTotal":
			a = '<header><h2>Opções para Exportação</h2>' +
				'<ul class="data-header-actions">'+
				'<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportStockTotalsToPDF">' +
				'<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
				'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
			    ...
			    '<input type="submit" value="PDF" class="btn btn-md btn-inverse pull-right"/></li>' +
			    '</form>' +
			    '<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportStockTotalsToExcel">' +
			    '<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
				'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
		...
		case "dailyProduction":
			...
			a = '<header><h2>Opções para Exportação</h2>' +
				'<ul class="data-header-actions">'+
				'<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportDailyProduction">' +
				'<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
				'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
				'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
		...
		case "pallets":
			a = '<header><h2>Opções para Exportação</h2>' +
			'<ul class="data-header-actions">'+
			'<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportPalletsToPDF">' +
			'<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
			'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
			'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
			'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
		    ...
		    '<input type="submit" value="PDF" class="btn btn-md btn-inverse pull-right"/></li>' +
		    '</form>' +
		    '<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/stocks/exportPalletsToExcel">' +
		    '<input type="hidden" class="form-control" name="filter.companyIdDe" id="filter.companyIdDe" value="'+ filialId.value +'" >' +
			'<input type="hidden" class="form-control" name="filter.companyIdAte" id="filter.companyIdAte" value="'+ filialId2.value +'" />'+
			'<input type="hidden" class="form-control" name="filter.terminalId" id="filter.terminalId" value="'+ terminalId.value +'" >' +
			'<input type="hidden" class="form-control" name="filter.terminalId_2" id="filter.terminalId_2" value="'+ terminalId2.value +'" />'+
		...
		case "listOrders":
			a = '<header><h2>Opções para Exportação</h2>' +
				'<ul class="data-header-actions">'+				
			    '<li><form class="form-horizontal" name="form_search" method="post" action="/cardealsgf/orders/exportOrdersToExcel">' +
