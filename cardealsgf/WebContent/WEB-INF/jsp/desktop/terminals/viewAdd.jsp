				...
				<div class="row">						
					<div class="col-md-8 col-md-offset-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input class="form-control" type="text" maxlength="2" name="terminal.company.id" id="terminal.company.id" value="${terminal.company.id}" />
							</div>
						</div>						
						<div class="form-group">
							<label for="terminal.id" class="col-sm-3 control-label">Código Terminal</label>
							<div class="col-sm-6">
								<input class="form-control" type="text" maxlength="2" name="terminal.idTerminal" id="terminal.idTerminal" value="${terminal.idTerminal}" />
							</div>
						</div>	
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" name="terminal.printerModel">
					                ...
					                <c:forEach items="${printerModels}" var="model">					                	
					                	<option value="${model}" selected>${model.name}
					                </c:forEach>
							 	</select>
							</div>
						</div>
