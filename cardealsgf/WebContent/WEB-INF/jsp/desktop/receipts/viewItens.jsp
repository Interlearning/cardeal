...
<display:table class="simple"
		...
		<display:column property="qtyRequested" title="Qtd. Solicitada"/>
		<display:column property="unit.id" title="Und. Solicitada"/>
		<display:column property="qtyIssued" title="Qtd. Expedida"/>
		<display:column property="qtdMissing" title="Falta"/>
