...
<link rel="stylesheet" href="<c:url value='/resources/css/mobile-style.css'/>">
<link rel="stylesheet" href="<c:url value='/resources/css/jquery.mobile-1.4.2.min.css'/>">
<script type="text/javascript" src="<c:url value='/resources/js/jquery-1.9.1.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/jquery.mobile-1.4.2.min.js'/>"></script>
