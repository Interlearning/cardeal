...
public class TpOperacaoDlg extends JDialog {
	...
	public static void main(String[] args) {
		try {
			TpOperacaoDlg dialog = new TpOperacaoDlg();
	...
	public TpOperacaoDlg() {
		...
		*/
		...
		JLabel lblHeading = new JLabel("Tipo de Operação");
	...
	private Object[][] getTypeOperation() {
		
		data = (Object[][]) TypeOperation.getElementsInArray();		

		return data;
	}
	
	private TypeOperation selectedTpOperation= null;
	
	public TypeOperation getSelectedTpOperation() {
		return selectedTpOperation;
	}
	...
	private void confirm() {
		if(table.getSelectedRow() >= 0) {
			selectedTpOperation = (TypeOperation) data[table.getSelectedRow()][2];
			this.setVisible(false);
		}
	}
