...
public class TableItensShipmentDevolutionModel extends AbstractTableModel {
	
	private static final long serialVersionUID = 1L;
	private Object[][] colunsGrid;
	private List<ItensShipmentDevolution> dadosDaGrid;
	
	public TableItensShipmentDevolutionModel(List<ItensShipmentDevolution> dadosDaGrid) {
	...
	private void setColunsGrid() 
	{
		...
		colunsGrid[2][0] = new String("Descrição");
		colunsGrid[2][1] = new String("F");
		
		colunsGrid[3][0] = new String("Quantidade");
		colunsGrid[3][1] = new String("F");
		
		colunsGrid[4][0] = new String("Unidade");
	...
	public List<ItensShipmentDevolution> getDadosDaGrid() {
		return dadosDaGrid;
	}

	public void setDadosDaGrid(List<ItensShipmentDevolution> dadosDaGrid) {
		this.dadosDaGrid = dadosDaGrid;
	}
	...
	public void initializeLayout(JTable table) {
		...
		for (int i = 0; i < getColumnCount(); i++) 
		{
		    ...
		    switch(i) 
	    	{
		    	...
		    	case 2: column.setPreferredWidth(310);break;
		    	case 3: column.setPreferredWidth(120);break;
		    	case 4: column.setPreferredWidth(90);break;
		    	case 5: column.setPreferredWidth(70);break;
	...
	private void checkItemOnBd(ItensShipmentDevolution itensShipmentDevolution, boolean check) 
	{
		ShipmentDevolutionService service = new ShipmentDevolutionService();
		service.checkItemDevolution(itensShipmentDevolution, check);
	}
