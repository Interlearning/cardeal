...
public class TableItensShipmentPartialDevolutionModel extends AbstractTableModel {
	
	private static final long serialVersionUID = 1L;
	private Object[][] colunsGrid;
	private List<ItensShipmentPartialDevolution> dadosDaGrid;
	
	public TableItensShipmentPartialDevolutionModel(List<ItensShipmentPartialDevolution> dadosDaGrid) 
	{
	...
	private void setColunsGrid() 
	{
		...
		colunsGrid[0][0] = new String(" ");
		colunsGrid[0][1] = new String("T");
		
		colunsGrid[1][0] = new String("Serial");
		colunsGrid[1][1] = new String("F");
		
		colunsGrid[2][0] = new String("Produto");
		colunsGrid[2][1] = new String("F");
		
		colunsGrid[3][0] = new String("Descrição");
		colunsGrid[3][1] = new String("F");
		
		colunsGrid[4][0] = new String("Qtd.");
	...
	public List<ItensShipmentPartialDevolution> getDadosDaGrid() {
		return dadosDaGrid;
	}

	public void setDadosDaGrid(List<ItensShipmentPartialDevolution> dadosDaGrid) {
		this.dadosDaGrid = dadosDaGrid;
	}
	...
	public void initializeLayout(JTable table) 
	{
		...
		for (int i = 0; i < getColumnCount(); i++) 
		{
		    ...
		    switch(i) 
	    	{
		    	case 0: column.setPreferredWidth(20);break;
		    	case 1: column.setPreferredWidth(110);break;
		    	case 2: column.setPreferredWidth(90);break;
		    	case 3: column.setPreferredWidth(275);break;
		    	case 4: column.setPreferredWidth(60);break;
		    	case 5: column.setPreferredWidth(90);break;
		    	case 6: column.setPreferredWidth(115);break;
	...
	public Object getValueAt(int rowIndex, int columnIndex)
	{
		...
		switch(columnIndex) 
		{
			case 0: return dadosDaGrid.get(rowIndex).isChecked();
			case 1: return dadosDaGrid.get(rowIndex).getSerial();
			case 2: return dadosDaGrid.get(rowIndex).getProduct().getIdMasc();
			case 3: return dadosDaGrid.get(rowIndex).getProduct().getDescription();
			case 4: return dadosDaGrid.get(rowIndex).getQuantidade();
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) 
	{
		...
		switch(columnIndex) 
		{
			...
			checkItemOnBd( dadosDaGrid.get(rowIndex), check );
			break;
		}
		
	}
		
	private void checkItemOnBd(ItensShipmentPartialDevolution itensShipmentPartialDevolution, boolean check) 
	{
		ShipmentDevolutionService service = new ShipmentDevolutionService();
		service.checkItemDevolution(itensShipmentPartialDevolution, check);
	}
