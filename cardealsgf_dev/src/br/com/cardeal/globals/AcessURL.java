...
public class AcessURL 
{
	...
	public static void main(String... args){
		...
		AcessURL url = new AcessURL("http://192.168.1.58:8081/cardealsgf_dev/resources/labels/EtiquetaCaixa.txt");
		try {
...
//		   urlName = "http://192.168.1.58:8081/cardealsgf_dev/resources/labels/EtiquetaCaixa.txt";		
		try {
			url = new URL(urlName);
