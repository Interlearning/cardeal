...
public class Setup 
{
	...
	private static boolean refreshLabelsPrinterZebra( boolean copyLabelsFromServer ) {
		...
		String pathLabelsDefault = "http://" + GuiGlobals.getIpServer() + ":" + GuiGlobals.getPortaServer() + GuiGlobals.getSeparadorIvertido() + "cardealsgf_dev" + GuiGlobals.getSeparadorIvertido() + "resources" + GuiGlobals.getSeparadorIvertido() + "labels" + GuiGlobals.getSeparadorIvertido() ;
